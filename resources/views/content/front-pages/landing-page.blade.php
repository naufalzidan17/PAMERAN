            ...
            <div class="card shadow-none">
              ...
              <div class="card-body">
                ...
                <div class="text-center mt-6 pt-2">
                  <a href="{{ url('front-pages/landing') }}" class="btn btn-outline-primary w-100">Get Started</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-4 col-lg-6">
            <div class="card border-primary border-2 shadow-none">
              ...
              <div class="card-body">
                ...
                <div class="text-center mt-6 pt-2">
                  <a href="{{ url('front-pages/landing') }}" class="btn btn-primary w-100">Get Started</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="accordion-item active">
                <h2 class="accordion-header" id="head-Three">
                  <button type="button" class="accordion-button" data-bs-toggle="collapse"
                    data-bs-target="#accordionThree" aria-expanded="true" aria-controls="accordionThree">What is
                    regular
                    license?</button>
                </h2>
      ...
      <div class="container">
        <div class="row align-items-center gy-5 gy-lg-0">
          <div class="col-lg-6 text-center text-lg-start">
            ...
            <a href="{{ url('front-pages/landing') }}" class="btn btn-primary">Get Started<i
          ...
          <div class="col-lg-5">
            <div class="card h-100">
              <div class="bg-primary rounded-4 text-white card-body p-lg-8">
                ...
                <p class="mb-0 description">Looking for more customisation, more features, and more anything? Don’t
                  worry,
